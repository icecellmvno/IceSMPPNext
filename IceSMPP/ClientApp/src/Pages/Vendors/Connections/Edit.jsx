...
export default function Edit({ auth, vendor, connection }) {
    const { data, setData, put, processing, errors } = useForm({
        ...
        config: {
            ...
            endpoints: connection.config?.endpoints || [],
        },
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        put(route('vendors.connections.update', [vendor, connection]));
    };
    ...
    return (
        <AuthenticatedLayout
            user={auth.user}
            header={{
                title: `Edit Connection - ${vendor.name}`,
                module: "Vendors",
                breadcrumbs: [
        ...
        >
            <Head title={`Edit Connection - ${vendor.name}`} />
            ...
            <div className="container mx-auto py-6">
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            Update connection details for {vendor.name}
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="space-y-2">
                                ...
                                <Input
                                    ...
                                    placeholder="e.g. smpp.example.com"
                                />
                                {errors.host && (
